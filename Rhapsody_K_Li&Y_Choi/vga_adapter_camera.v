...
module vga_adapter_camera(
	...
	defparam
		VideoMemory_camera.WIDTH_A = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOUR_CHANNEL*3) : 1),
		VideoMemory_camera.WIDTH_B = ((MONOCHROME == "FALSE") ? (BITS_PER_COLOUR_CHANNEL*3) : 1),
		VideoMemory_camera.INTENDED_DEVICE_FAMILY = "Cyclone II",
		VideoMemory_camera.OPERATION_MODE = "DUAL_PORT",
		VideoMemory_camera.WIDTHAD_A = ((RESOLUTION == "320x240") ? (17) : (15)),
		VideoMemory_camera.NUMWORDS_A = ((RESOLUTION == "320x240") ? (76800) : (19200)),
		VideoMemory_camera.WIDTHAD_B = ((RESOLUTION == "320x240") ? (17) : (15)),
		VideoMemory_camera.NUMWORDS_B = ((RESOLUTION == "320x240") ? (76800) : (19200)),
		VideoMemory_camera.OUTDATA_REG_B = "CLOCK1",
		VideoMemory_camera.ADDRESS_REG_B = "CLOCK1",
		VideoMemory_camera.CLOCK_ENABLE_INPUT_A = "BYPASS",
		VideoMemory_camera.CLOCK_ENABLE_INPUT_B = "BYPASS",
		VideoMemory_camera.CLOCK_ENABLE_OUTPUT_B = "BYPASS",
		VideoMemory_camera.POWER_UP_UNINITIALIZED = "FALSE",
		VideoMemory_camera.INIT_FILE = BACKGROUND_IMAGE;
		

	vga_controller_camera controller_camera(
			.vga_clock(clock_25),
			.resetn(resetn),
		...
		defparam controller_camera.BITS_PER_COLOUR_CHANNEL  = BITS_PER_COLOUR_CHANNEL ;
		defparam controller_camera.MONOCHROME = MONOCHROME;
		defparam controller_camera.RESOLUTION = RESOLUTION;
